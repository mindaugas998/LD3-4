...
namespace LD3_4_v0._2
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            List<Student> studentPassed = new List<Student>();
            List<Student> studentFailed = new List<Student>();
        ...
        {
                StreamReader file = new StreamReader(@"C:\Users\006ic\source\repos\LD3-4 v0.4\LD3-4 v0.4\students.txt");
                string line;
        ...
        public static void generateLargeStudents(List<Student> students)
        {
            Stopwatch fileCreationTime = Stopwatch.StartNew();
            string students10k = @"C:\Users\006ic\source\repos\LD3-4 v0.4\LD3-4 v0.4\students10k.txt";
            string students100k = @"C:\Users\006ic\source\repos\LD3-4 v0.4\LD3-4 v0.4\students100k.txt";
            string students1mil = @"C:\Users\006ic\source\repos\LD3-4 v0.4\LD3-4 v0.4\students1mil.txt";
            string students10mil = @"C:\Users\006ic\source\repos\LD3-4 v0.4\LD3-4 v0.4\students10mil.txt";
        ...
        public static void divideStudents(List<Student> studentPassed, List<Student> studentFailed)
        {
            ...
            string students10k_p = @"C:\Users\006ic\source\repos\LD3-4 v0.4\LD3-4 v0.4\students10k_p.txt";
            string students100k_p = @"C:\Users\006ic\source\repos\LD3-4 v0.4\LD3-4 v0.4\students100k_p.txt";
            string students1mil_p = @"C:\Users\006ic\source\repos\LD3-4 v0.4\LD3-4 v0.4\students1mil_p.txt";
            string students10mil_p = @"C:\Users\006ic\source\repos\LD3-4 v0.4\LD3-4 v0.4\students10mil_p.txt";

            string students10k_f = @"C:\Users\006ic\source\repos\LD3-4 v0.4\LD3-4 v0.4\students10k_f.txt";
            string students100k_f = @"C:\Users\006ic\source\repos\LD3-4 v0.4\LD3-4 v0.4\students100k_f.txt";
            string students1mil_f = @"C:\Users\006ic\source\repos\LD3-4 v0.4\LD3-4 v0.4\students1mil_f.txt";
            string students10mil_f = @"C:\Users\006ic\source\repos\LD3-4 v0.4\LD3-4 v0.4\students10mil_f.txt";
            ...
            while ((line = file.ReadLine()) != null)
            {
                ...
                if (finalpoints < 5) { studentFailed.Add(st); }
                else { studentPassed.Add(st); }
            }
